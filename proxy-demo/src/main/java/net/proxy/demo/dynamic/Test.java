 ...
 */
package net.proxy.demo.dynamic;
...
public class Test {
    ...
    public static void main(String[] args) {
        ...
        EmailService emailService = (EmailService) MyJdkProxyFactory.getProxy(new EmailServiceImpl());
        emailService.send("This is a jdk proxy message");
    }
}
